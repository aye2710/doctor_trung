...
export const doctorProfile: DoctorProfile = {
  ...
  hospitalTitle: "Bác sĩ Gây mê Hồi sức & Điều trị đau — Đồng hành cùng bạn từ cơn đau đến phục hồi",
  specialty: "Điều trị Đau",
  hospital: "Bệnh viện Bưu Điện",
  hospitalAddress: "49 Trần Điền, Phương Liệt, Hà Nội",
  phone: "097561215",
  zalo: "097561215",
  email: "damquangtrung1206@gmail.com",
  experience: "5 năm kinh nghiệm chuyên môn",
  casesPerformed: "> 3.000 ca",
  focusAreas: [
  ...
  quote: "Mỗi bệnh nhân đều xứng đáng có một cuộc sống ít đau hơn, ngủ ngon hơn và vận động dễ dàng hơn.",
