    ...
    >
      <div className="max-w-[1280px] mx-auto px-6 md:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-heading font-bold text-primary leading-tight mt-2 mb-4">
        ...
        <div className="flex flex-col gap-10">
          {painPoints.map((point, i) => (
            ...
            >
              ...
              {/* Detail Card */}
              <div className="flex-1 bg-surface border border-border rounded-[24px] p-6 md:p-8">
